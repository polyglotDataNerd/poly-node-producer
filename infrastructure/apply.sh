...
aws s3 cp s3://sweetgreen-bigdata-utility/lambda/qsr/config/ ~/sg-QSR-producer/app/utils --recursive --sse --quiet --include "*"
...
aws s3 cp ~/sg-QSR-producer/ s3://sweetgreen-bigdata-utility/lambda/qsr/ --recursive --sse --quiet --exclude "*" --include "*sg-QSR-producer-Auth.zip*"
